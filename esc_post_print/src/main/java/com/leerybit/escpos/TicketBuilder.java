...
public class TicketBuilder {
   ...
   * @return TicketBuilder
   */
  public TicketBuilder textList(List<String> text) {
    return textList(text, TextAlignment.LEFT);
  }
  ...
  public TicketBuilder text(String text, TextAlignment alignment) {
   text =  text.replace("ë","e").replace("Ë","E");
   ...
   * └────────────────────┘
   *
   * @param texts      text value
   * @param alignment text alignment
   * @return TicketBuilder
   */
  public TicketBuilder textList(List<String> texts, TextAlignment alignment) {
    for (String text:
         texts) {
      if (text.equals("")){
        ticket.feed(1);
  ...
  public TicketBuilder image(Bitmap bitmap) {
