...
public class DeviceActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.planetaccounting.saleAgent.R.layout.activity_device);
        setResult(RESULT_CANCELED);
                     
        mInflater = (LayoutInflater)getApplicationContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);                
        mListItems = new ArrayList<Pair<String,String>>();
        mListView = (ListView)findViewById(org.planetaccounting.saleAgent.R.id.listView);
        ...
        findViewById(org.planetaccounting.saleAgent.R.id.cancel).setOnClickListener(new OnClickListener() {
			@Override
